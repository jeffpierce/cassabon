...
func RedisClient(raddr []string, rpwd string, rdb int64) (*redis.Client, error) {
...
func RedisFailoverClient(raddr []string, rpwd, master string, rdb int64) (*redis.Client, error) {
...
func testRedisClient(rclient *redis.Client) (*redis.Client, error) {
